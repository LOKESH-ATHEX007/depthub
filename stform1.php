...
if(isset($_POST['submit'])){
    ...
    // Prepare SQL statement for inserting into st1 table
    $str = "INSERT INTO st1 (regno, imageFile, stName, dob, gender, department, class, currentYear, fatherName, motherName, studentType, scholarship, bloodGroup, permanentAddress, currentAddress, community, caste, religion, fatherOccupation, motherOccupation, parentPhno, studentPhno, email, placement) 
            VALUES (:regno, :imageFile, :stName, :dob, :gender, :department,:class, :currentYear, :fatherName, :motherName, :studentType, :scholarship, :bloodGroup, :permanentAddress, :currentAddress, :community, :caste, :religion, :fatherOccupation, :motherOccupation, :parentPhno, :studentPhno, :email, :placement)";
