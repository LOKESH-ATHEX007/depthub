...
try {
    ...
    // Function to execute filtered queries
    function fetchFilteredRequests($conn, $status, $dept_id, $startDate, $endDate) {
        ...
        mysqli_stmt_bind_param($stmt, "ssss", $status, $dept_id, $startDate, $endDate);
    ...
    $underProcessRequests = fetchFilteredRequests($conn, 'Under Process', $dept_id, $startDate, $endDate);
    $approvedRequests = fetchFilteredRequests($conn, 'Approved', $dept_id, $startDate, $endDate);
    $rejectedRequests = fetchFilteredRequests($conn, 'Rejected', $dept_id, $startDate, $endDate);
